...
plt.savefig(f"figs/{project_name}_VGG--{BATCH_SIZE}_{num_epochs}_{SCHEDULER}.png")
plt.show()

plt.figure()
plt.plot(x_axis,learning_rate)
plt.savefig(f"figs/{project_name}_VGG--{BATCH_SIZE}_{num_epochs}_{SCHEDULER}_RATE.png")
plt.show()



with open(f"figs/{project_name}_VGG--{BATCH_SIZE}_{num_epochs}_{SCHEDULER}.csv","w") as f:
    f.write("epoch,accuracy\n")
    for i in range(len(x_axis)):
        f.write(f"{x_axis[i]},{acc[i]}\n")

with open(f"figs/{project_name}_VGG--{BATCH_SIZE}_{num_epochs}_{SCHEDULER}_RATE.csv","w") as f:
