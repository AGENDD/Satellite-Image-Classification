...
fix = pd.read_csv('figs/data/projects/p1_Model1--128_200_0.0002.csv')
cyclic = pd.read_csv('figs/data/projects/p2_Model1--128_200_CyclicLR.csv')
oneCycle = pd.read_csv('figs/data/projects/p2_Model1--128_200_OneCycleLR.csv')
reduceLROnPlateau = pd.read_csv('figs/data/projects/p2_Model1--128_200_ReduceLROnPlateau.csv')
